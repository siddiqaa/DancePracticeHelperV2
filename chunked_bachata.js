    ...
    if (currentLabelEl && nextLabelEl) {
        currentLabelEl.innerHTML = `<div class="active-move-animate flex flex-col items-center justify-center gap-2">
            <div class="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                <span class="text-indigo-400 font-black text-lg sm:text-xl md:text-2xl px-3 py-1 rounded bg-indigo-950/40 border border-indigo-900/30 flex items-center gap-1 font-mono">${countLabel}</span>
