const WCS_LANDMARKS = [

    {
        ...
        links: [
            ...
            { id: 2, url: "https://youtu.be/EvvVBMtRnLY?t=84s", label: "Double Hand ST with Popout" },
            { id: 3, url: "https://youtu.be/EvvVBMtRnLY?t=167s", label: "ST Elbow Catch with Double Spin" },
            { id: 4, url: "https://youtu.be/8b-S82Eio-4", label: "Sugar Roll/Push to Right Side with Shoulder Guide Back" },
            { id: 5, url: "https://youtu.be/8b-S82Eio-4?t=55s", label: "Sugar Waist Catch and Spin Back" },
            { id: 6, url: "https://youtu.be/8b-S82Eio-4?t=100s", label: "Drama Sugar Push" },
